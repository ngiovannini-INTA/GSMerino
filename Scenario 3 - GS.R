...
#GS + PED
    ...
    pre.snp.i <- cbind(id.ref, pre.snp.ref)
        ...
        for (year in 11:21) {
          ...
          write.fwf(pre.snp.i, file = "/home/corva/NicoG/doc/snp.dat", sep="", rownames = F, colnames = F, width = c(6,52000))
          
          #Local windows
          #write.table(ped, file = "d:/PROVINO/temp/e3/ped.dat", sep=" ", row.names = F, col.names = F, quote=F, na='-999')
          #write.table(dat, file = "d:/PROVINO/temp/e3/dat.dat", sep=" ", row.names = F, col.names = F, quote=F, na='-999')
          #write.fwf(pre.snp.i, file = "d:/PROVINO/temp/e3/snp.dat", sep="", rownames = F, colnames = F, width = c(6,52000))
          
          #run BLUP in local windows
          #setwd('d:/PROVINO/temp/e3/')
       ...
       #local windows
       #write.table(out,paste('d:/PROVINO/temp/e3/','out_Rep',rep,'.csv', sep=''),sep=';',row.names = F)
       #write.table(cor,paste('d:/PROVINO/temp/e3/','cor_Rep',rep,'.csv', sep=''),sep=';',row.names = F)
