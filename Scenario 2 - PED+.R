...
for (year in 11:21) {
  ...
  #The animals are phenotyped at 1 year of age
  sires0 = attrition(sires0, p=0.40) #phanotyped males 60% of DES=1
  sires0 = setPheno(sires0, h2 = c(0.20, 0.30, 0.45, 0.35), traits = c(2,3,4,5))
  
  dams0 = attrition(dams0, p=0.1) ##phenotyped females 90% of DES=1 
  dams0 = setPheno(dams0, h2 = c(0.20, 0.30, 0.45, 0.35), traits = c(2,3,4,5))
  ...
  #local
  #write.table(ped, file = "d:/PROVINO/temp/e2/ped.dat", sep=" ", row.names = F, col.names = F, quote=F, na='-999')
  #write.table(dat, file = "d:/PROVINO/temp/e2/dat.dat", sep=" ", row.names = F, col.names = F, quote=F, na='-999')
...
#local windows
#write.table(out,paste('d:/PROVINO/temp/e2/','out_Rep',rep,'.csv', sep=''),sep=';',row.names = F)
#write.table(cor,paste('d:/PROVINO/temp/e2/','cor_Rep',rep,'.csv', sep=''),sep=';',row.names = F)
...
#local windows
#write.table(out.i,"d:/PROVINO/temp/e2/out.csv", sep=';',row.names = F)
#write.table(cor.i,"d:/PROVINO/temp/e2/cor.csv", sep=';',row.names = F)
